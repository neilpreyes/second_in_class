...
static PtrToConst searchEmployeeTable(PtrToConstEmployee ptr, int tableSize, const void *targetPtr, int (*functionPtr)(const void *, PtrToEmployee)){
...
static int compareEmployeeNumber(const void *targetPtr, PtrToConstEmplyee tableValuePtr){
